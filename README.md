...
# Known Issues
As of right now, the root mean squared error is too large of an error to be deemed reliable and accurate. While it effectively uses weather delays and arriving flights to predict, the large error indicates that there is a variable that contributes more to delays by 15 minutes. Underfitting describes this senario, as it is a common problem faced by many.
